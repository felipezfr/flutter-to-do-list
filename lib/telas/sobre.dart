...
import 'package:flutter_application_teste_not/telas/mais_info.dart';
import 'package:flutter_application_teste_not/util/dialogos.dart';
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    Dialogos.showConfirmDialog(
                        context,
                        'Você deseja mesmo voltar?',
                        () => {
                              Dialogos.showAlertDialog(
                                  context,
                                  'Volte sempre :)',
