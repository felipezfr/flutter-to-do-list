...
import 'package:flutter_application_teste_not/api/projeto_api.dart';
import 'package:flutter_application_teste_not/dominio/projeto.dart';
import 'package:flutter_application_teste_not/telas/projeto_edit.dart';
...
class ProjetoListPageState extends State<ProjetoListPage> {
  ...
  void _editar(Projeto selecao) async {
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => ProjetoEditPage(obj: selecao),
      ),
    );
    _atualizarLista();
  }
